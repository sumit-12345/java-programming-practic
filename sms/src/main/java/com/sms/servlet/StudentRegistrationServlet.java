...
public class StudentRegistrationServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        boolean isRegistired = studentService.registerStudent(student);
        if (isRegistired) {
            successfulStudentRegistration(resp.getWriter());
        } else {
            failureStudentRegistration(resp.getWriter());
        }
    }

    private void successfulStudentRegistration(PrintWriter out) {
        ...
        out.println("<p>Congratulations, the student has been successfully registered.</p>");
        out.println("</div>");
    ...
    private void failureStudentRegistration(PrintWriter out) {
        out.println("<html lang='en'>");
        out.println("<head>");
        out.println("<meta charset='UTF-8'>");
        out.println("<meta name='viewport' content='width=device-width, initial-scale=1.0'>");
        ...
        out.println("<p>Oops, something went wrong. The student could not be registered.</p>");
        out.println("</div>");
        out.println("<a href='javascript:history.back()' class='btn btn-back'>Go Back</a>");
        out.println("</div>");
        out.println("</div>");
